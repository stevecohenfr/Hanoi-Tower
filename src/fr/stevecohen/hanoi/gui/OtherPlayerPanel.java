...
public class OtherPlayerPanel extends JPanel {
	...
	private static final long serialVersionUID = -7593678449580475857L;
	...
	public OtherPlayerPanel() {
		initShapes();
		eventBus.on("otherPlayerAction", new EventBus.EventCallback() {
	...
	public void initShapes() {
		...
		changeSelectedPiece(row2.get(row2.size()-1));
	}
